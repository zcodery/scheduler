...
export const getMockStaffData = (count = 0) => {
  ...
  return Array.from({ length: count }, (_, index) => ({
    ...
    isCollapsed: false,
    tasks: Array.from({ length: Math.ceil(Math.random() * 10) }, (_, i) => ({
